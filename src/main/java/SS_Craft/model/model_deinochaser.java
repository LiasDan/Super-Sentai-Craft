...
public class model_deinochaser extends model_belt_plus
{
  //fields
  ...
  public model_deinochaser()
  {
    ...
    textureHeight = 128;
      ...
      Shape3.addBox(-1.5F, -4F, -11F, 4, 2, 8);
      Shape3.setRotationPoint(1F, 13.5F, -7F);
      Shape3.setTextureSize(64, 128);
      Shape3.mirror = true;
      setRotation(Shape3, -0.2224078F, 0F, 0F);
      ...
      Shape42.addBox(0F, 0F, -2F, 4, 1, 4);
      Shape42.setRotationPoint(-0.5F, 1.5F, -10F);
      Shape42.setTextureSize(64, 128);
      Shape42.mirror = true;
      setRotation(Shape42, 1.375609F, 0F, 0F);
      ...
      Shape4.setRotationPoint(3.5F, 9F, -4F);
