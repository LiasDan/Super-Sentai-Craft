...
public class MobWithBeltModel extends ModelBiped
{
	...
	public Item BELT;
	public String TEXT2;
	public MobWithBeltModel(Item belt, String text2)
	{
		TEXT2=text2;
		BELT=belt;
	...
	GL11.glPushMatrix();
       ...
       this.bipedHeadwear2.render(f5);
		...
		if (entity instanceof EntityLivingBase){
			...
			Minecraft.getMinecraft().getItemRenderer().renderItem((EntityLivingBase) entity,stack,null);
			Minecraft.getMinecraft().getItemRenderer().renderItem((EntityLivingBase) entity,stack2,null);
