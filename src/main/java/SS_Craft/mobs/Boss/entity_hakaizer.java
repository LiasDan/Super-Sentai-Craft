...
public class entity_hakaizer extends EntityBossBase
//implements IBossDisplayData
{
	public static final Item[] weapon = new Item[] {SentaiItems60.zenryoku_zenkai_cannon,SentaiItems60.v_merang,SentaiItems60.zenryoku_zenkai_cannon,SentaiItems60.v_merang,SentaiItems60.zenryoku_zenkai_cannon};
	
	public entity_hakaizer(World par1World)
	{
		super(par1World);
		...
		this.setItemStackToSlot(EntityEquipmentSlot.FEET,new ItemStack(SentaiItems60.hakaizer_belt));
	...
	public void onDeath(DamageSource cause)
	{
		if (!this.world.isRemote)
		{
			...
			{   		   	    		
			case 0:
				this.dropItem(SentaiItems60.hakaizer_belt, 1);
				break;		   	    		
			case 1:
				this.dropItem(SentaiItems60.zenryoku_zenkai_cannon, 1);
				break;		   	    		
			case 2:
				this.dropItem(SentaiItems60.v_merang, 1);
				break;
			}
		}
	}
