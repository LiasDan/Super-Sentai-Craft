...
public class entity_ryusoul_moria extends EntityBossBase
//implements IBossDisplayData
{
	public entity_ryusoul_moria(World par1World)
	{
		super(par1World);
		...
		this.setItemStackToSlot(EntityEquipmentSlot.FEET,new ItemStack(SentaiItems60.moria_ryusoul_changer));
	...
	public void onDeath(DamageSource cause)
	{
		if (!this.world.isRemote)
		{
			...
			{   		   	    		
			case 0:
				this.dropItem(SentaiItems60.moria_ryusoul_changer, 1);
				break;
			}
		}
	}
