...
public class entity_sononi extends EntityBossBase
//implements IBossDisplayData
{
	public entity_sononi(World par1World)
	{
		super(par1World);
		this.setItemStackToSlot(EntityEquipmentSlot.MAINHAND,new ItemStack(SentaiItems60.condor_arrow));
		...
		this.setItemStackToSlot(EntityEquipmentSlot.FEET,new ItemStack(SentaiItems60.sononi_nouto_brace));
	...
	public void onDeath(DamageSource cause)
	{
		if (!this.world.isRemote)
		{
			...
			case 1:
				...
				break; 		   	    		
			case 2:
				this.dropItem(SentaiItems60.condor_sword, 2);
				break;
			}
		}
	}
