...
public class entity_don_momotarou extends EntityGolem
{
	...
	public entity_don_momotarou(World par1World)
	{
		super(par1World);
		...
		item_geartlinger.set_core(this.getItemStackFromSlot(EntityEquipmentSlot.FEET), 45);
		
		this.tasks.addTask(1, new EntityAISwimming(this));
		this.tasks.addTask(2, new EntityAIWander(this, 0.4F));
		this.tasks.addTask(3, new EntityAILeapAtTarget(this, 0.4F));
		this.tasks.addTask(4, new EntityAIAttackMelee(this, 1.0D, true));
		this.tasks.addTask(5, new EntityAITempt(this, 1.0D, SentaiItems60.geartlinger, false));
	...
	public void onDeath(DamageSource cause)
	{
		if (!this.world.isRemote){
			...
			this.dropItem(SentaiItems60.don_brothers_gear, 1);
