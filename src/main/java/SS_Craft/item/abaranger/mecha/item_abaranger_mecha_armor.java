...
public class item_abaranger_mecha_armor extends ItemArmor  implements IHasModel
{
	private static final int[] maxDamageArray = new int[] {11, 16, 15, 13};
	public String armorNamePrefix;
	public ArmorMaterial material;

	public item_abaranger_mecha_armor (String name,ArmorMaterial par2EnumArmorMaterial, int par3, EntityEquipmentSlot par4)
	{
	...
	public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type)
	{
		if (entity instanceof EntityLivingBase)
		{
			...
			{
				if (player.getItemStackFromSlot(EntityEquipmentSlot.HEAD).getItem() instanceof item_abaranger_mecha)
				{
					String rider = ((item_abaranger_mecha)player.getItemStackFromSlot(EntityEquipmentSlot.HEAD).getItem()).Rider;
					
					if (item_abaranger_mecha.get_right(player.getItemStackFromSlot(EntityEquipmentSlot.HEAD)) != "blank" && item_abaranger_mecha.get_right(player.getItemStackFromSlot(EntityEquipmentSlot.HEAD)) != "abaren_galer")
					{
						return Refercence.MODID+":textures/armor/mecha/"+item_abaranger_mecha.get_right(player.getItemStackFromSlot(EntityEquipmentSlot.HEAD))+".png";
					}
					else
					{
	...
	public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel)
	{
		if(!stack.isEmpty())
		{
			if(stack.getItem() instanceof item_abaranger_mecha_armor)
			{
