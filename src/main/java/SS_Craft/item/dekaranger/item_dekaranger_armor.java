...
public class item_dekaranger_armor extends ItemArmor  implements IHasModel
{
	private static final int[] maxDamageArray = new int[] {11, 16, 15, 13};
	public String armorNamePrefix;
	public ArmorMaterial material;

	public item_dekaranger_armor (String name,ArmorMaterial par2EnumArmorMaterial, int par3, EntityEquipmentSlot par4)
	{
	...
	public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type)
	{
		if (entity instanceof EntityLivingBase)
		{
			...
			{
				if (player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() instanceof item_sp_license)
				{
					String rider = ((item_sp_license)player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem()).Rider;
					
					if (item_sp_license.get_lock(player.getItemStackFromSlot(EntityEquipmentSlot.FEET))=="fire_squad_armor")
					{
						return Refercence.MODID+":textures/armor/deka_red_"+item_sp_license.get_lock(player.getItemStackFromSlot(EntityEquipmentSlot.FEET))+".png";
					}
					else if (rider == "neo_deka_red" || rider == "neo_deka_yellow")
					{
						return Refercence.MODID+":textures/armor/"+item_sp_license.get_lock(player.getItemStackFromSlot(EntityEquipmentSlot.FEET))+"_1.png";
					}
					else if (item_sp_license.get_lock(player.getItemStackFromSlot(EntityEquipmentSlot.FEET))!="blank")
					{
						return Refercence.MODID+":textures/armor/"+rider+"_"+item_sp_license.get_lock(player.getItemStackFromSlot(EntityEquipmentSlot.FEET))+"_1.png";
					}
					else if (item_sp_license.get_lock(player.getItemStackFromSlot(EntityEquipmentSlot.FEET))=="blank")
					{
	...
	public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel)
	{
		if(!stack.isEmpty())
		{
			if(stack.getItem() instanceof item_dekaranger_armor)
			{
