...
public class item_dekaranger_armor2 extends ItemArmor  implements IHasModel
{
	...
	public item_dekaranger_armor2 (String name,ArmorMaterial par2EnumArmorMaterial, int par3, EntityEquipmentSlot par4)
	{
			...
			if (player.getItemStackFromSlot(EntityEquipmentSlot.FEET)!= null)
			{
				if (player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() instanceof item_sp_license)
				{
					...
					if (rider=="deka_red")
					{
						...
						{
							return Refercence.MODID+":textures/armor/"+rider+DekaRed[item_sp_license.get_core(player.getItemStackFromSlot(EntityEquipmentSlot.FEET))]+"_2.png";
						}
						if (slot == EntityEquipmentSlot.HEAD||slot == EntityEquipmentSlot.CHEST  )
						{
							return Refercence.MODID+":textures/armor/"+rider+DekaRed[item_sp_license.get_core(player.getItemStackFromSlot(EntityEquipmentSlot.FEET))]+"_1.png";
						}
					}
					if (rider=="neo_deka_red")
					{
						if ( slot == EntityEquipmentSlot.LEGS)
						{
							return Refercence.MODID+":textures/armor/deka_red_2.png";
						}
						if (slot == EntityEquipmentSlot.HEAD||slot == EntityEquipmentSlot.CHEST  )
						{
							return Refercence.MODID+":textures/armor/deka_red_1.png";
						}
					}
					if (rider=="neo_deka_yellow")
					{
						if ( slot == EntityEquipmentSlot.LEGS)
						{
							return Refercence.MODID+":textures/armor/deka_yellow_2.png";
						}
						if (slot == EntityEquipmentSlot.HEAD||slot == EntityEquipmentSlot.CHEST  )
						{
							return Refercence.MODID+":textures/armor/deka_yellow_1.png";
						}
					}
					else
					{
	...
	public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel)
	{
		if(!stack.isEmpty())
		{
			if(stack.getItem() instanceof item_dekaranger_armor2)
			{ 
