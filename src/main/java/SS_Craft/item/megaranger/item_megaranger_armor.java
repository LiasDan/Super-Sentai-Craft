...
public class item_megaranger_armor extends ItemArmor  implements IHasModel
{
	private static final int[] maxDamageArray = new int[] {11, 16, 15, 13};
	public String armorNamePrefix;
	public ArmorMaterial material;

	public item_megaranger_armor (String name,ArmorMaterial par2EnumArmorMaterial, int par3, EntityEquipmentSlot par4)
	{
	...
	public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type)
	{
		if (entity instanceof EntityLivingBase)
		{
			...
			{
				if (player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() instanceof item_digitaizer)
				{
					String rider = ((item_digitaizer)player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem()).Rider;
					
					return Refercence.MODID+":textures/armor/"+item_digitaizer.get_lock(player.getItemStackFromSlot(EntityEquipmentSlot.FEET))+"_1.png";
				}
	...
	public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel)
	{
		if(!stack.isEmpty())
		{
			if(stack.getItem() instanceof item_megaranger_armor)
			{
