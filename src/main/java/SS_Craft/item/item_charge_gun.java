...
public class item_charge_gun extends ItemBow  implements IHasModel
{
	...
	public void onPlayerStoppedUsing(ItemStack stack, World worldIn, EntityLivingBase entityLiving, int timeLeft)
	{
		if (entityLiving instanceof EntityPlayer)
		{
			...
			if (!worldIn.isRemote)
			{
					...
					else if (get_core(stack)==50)
					{
						fireball.setDamage(K*2);
						fireball.setKnockbackStrength(K*2);
					}
	...
	{
		return itemstack.hasTagCompound() ? itemstack.getTagCompound().getInteger("hit") :0;
	}
	...
	public static void set_core(ItemStack itemstack, int flag)
	{
		...
		itemstack.getTagCompound().setInteger("hit", flag);
	}
}