...
public class item_boukenger_armor extends ItemArmor  implements IHasModel
{
	private static final int[] maxDamageArray = new int[] {11, 16, 15, 13};
	public String armorNamePrefix;
	public ArmorMaterial material;

	public item_boukenger_armor (String name,ArmorMaterial par2EnumArmorMaterial, int par3, EntityEquipmentSlot par4)
	{
	...
	public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type)
	{
		if (entity instanceof EntityLivingBase)
		{
			...
			{
				if (player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() instanceof item_accellular)
				{
					String rider = ((item_accellular)player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem()).Rider;
					
					return Refercence.MODID+":textures/armor/"+item_accellular.get_lock(player.getItemStackFromSlot(EntityEquipmentSlot.FEET))+"_1.png";
				}
	...
	public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel)
	{
		if(!stack.isEmpty())
		{
			if(stack.getItem() instanceof item_boukenger_armor)
			{
