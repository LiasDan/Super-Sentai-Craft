...
public class item_ninja_ichibantou extends ItemArmor implements IHasModel
{
	...
	public item_ninja_ichibantou (String name,ArmorMaterial par2EnumArmorMaterial, int par3, String rider)
	{
	...
	{	
		return itemstack.hasTagCompound() ? item_nin_shuriken.ARMOR[itemstack.getTagCompound().getInteger("armor")] : "blank";
	}
					...
					if (player.getItemStackFromSlot(EntityEquipmentSlot.FEET)!= null)
					{
						if (player.getItemStackFromSlot(EntityEquipmentSlot.LEGS).getItem() == SentaiItems20.kawarimono_legs)
						{
							if (player.getItemStackFromSlot(EntityEquipmentSlot.CHEST).getItem() == SentaiItems20.kawarimono_torso)
							{
								...
								{
									if (player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() == SentaiItems20.aka_ninja_ichibantou)
									{
									...
									if (this.get_lock(armor)=="_chouzetsu")
									{
