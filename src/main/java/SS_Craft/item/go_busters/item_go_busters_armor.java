...
public class item_go_busters_armor extends ItemArmor  implements IHasModel
{
	private static final int[] maxDamageArray = new int[] {11, 16, 15, 13};
	public String armorNamePrefix;
	public ArmorMaterial material;

	public item_go_busters_armor (String name,ArmorMaterial par2EnumArmorMaterial, int par3, EntityEquipmentSlot par4)
	{
	...
	public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type)
	{
		if (entity instanceof EntityLivingBase)
		{
			...
			{
				if (player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() instanceof item_morphin_brace)
				{
					String rider = ((item_morphin_brace)player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem()).Rider;
					
					if (item_morphin_brace.get_lock(player.getItemStackFromSlot(EntityEquipmentSlot.FEET))=="_animal_perfect")
					{
						return Refercence.MODID+":textures/armor/"+rider+item_morphin_brace.get_lock(player.getItemStackFromSlot(EntityEquipmentSlot.FEET))+".png";
					}
					else if (item_morphin_brace.get_lock(player.getItemStackFromSlot(EntityEquipmentSlot.FEET))!="blank")
					{
						return Refercence.MODID+":textures/armor/"+rider+item_morphin_brace.get_lock(player.getItemStackFromSlot(EntityEquipmentSlot.FEET))+"_1.png";
					}
					else if (item_morphin_brace.get_lock(player.getItemStackFromSlot(EntityEquipmentSlot.FEET))=="blank")
					{
	...
	public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel)
	{
		if(!stack.isEmpty())
		{
			if(stack.getItem() instanceof item_go_busters_armor)
			{
