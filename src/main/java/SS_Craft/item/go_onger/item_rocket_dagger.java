...
public class item_rocket_dagger extends ItemPickaxe implements IHasModel
{
    ...
    public item_rocket_dagger(String name,ToolMaterial par2EnumToolMaterial)
    {
	...
	{
		if (this == SentaiItems40.rocket_dagger)
		{
