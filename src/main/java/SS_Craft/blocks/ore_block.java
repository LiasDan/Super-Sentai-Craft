...
*/		//25 Gaoranger
		...
		{
			int rand = generator.nextInt(508);
			...
			if (rand<252) return SentaiItems60.zenkai_zyu_gear;
			if (rand<253) return SentaiItems60.new_zenkaizer_gear;
			if (rand<254) return SentaiItems60.don_brothers_gear;
