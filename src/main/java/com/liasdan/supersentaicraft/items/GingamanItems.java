...
public class GingamanItems {
	...
	public static final RegistryObject<Item> RED_GINGA_MEDAL = ITEMS.register("red_ginga_medal",
            () -> new RangerFormChangeItem(new Item.Properties(),0,"","ginga_red","gingaman_belt",
            		...
            		new MobEffectInstance(EffectCore.SLASH.get(), 40, 2,true,false)).ChangeBeltModel("geo/rangerbeltextra.geo.json").AddToTabList(RangerTabs.GINGAMAN));
	...
	public static final RegistryObject<Item> GREEN_GINGA_MEDAL = ITEMS.register("green_ginga_medal",
            () -> new RangerFormChangeItem(new Item.Properties(),0,"","ginga_green","gingaman_belt",
            		...
            		new MobEffectInstance(EffectCore.FLYING.get(), 40, 2,true,false)).ChangeBeltModel("geo/rangerbeltextra.geo.json").AddToTabList(RangerTabs.GINGAMAN));
	...
	public static final RegistryObject<Item> BLACK_KNIGHT_CORE = ITEMS.register("black_knight_core",
            () -> new RangerFormChangeItem(new Item.Properties(),0,"","black_knight","black_knight_belt",
            		...
            		new MobEffectInstance(MobEffects.DIG_SPEED, 40, 2,true,false),
            		new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 2,true,false),
            		new MobEffectInstance(EffectCore.SLASH.get(), 40, 2,true,false)).ChangeBeltModel("geo/black_knight_belt.geo.json").AddToTabList(RangerTabs.GINGAMAN));
    ...
    public static final RegistryObject<Item> GINGA_NO_HIKARI = ITEMS.register("lights_of_ginga",
            ...
            .addSwitchForm(OtherItems.BLANK_FORM.get()).ChangeSlot(2).ChangeBeltModel("geo/rangerbeltextra.geo.json")
    ...
    public static final RegistryObject<Item> BLACK_KNIGHT_BULL_RIOT = ITEMS.register("black_knight_bull_riot",
    		() -> new GingaBraceItem(ArmorMaterials.DIAMOND,"black_knight",BLACK_KNIGHT_CORE,GINGAMAN_HELMET,GINGAMAN_CHESTPLATE,GINGAMAN_LEGGINGS,new Item.Properties())
    		.Add_Extra_Base_Form_Items(OtherItems.BLANK_FORM).AddToTabList(RangerTabs.GINGAMAN).ChangeRepairItem(GINGAMAN_LOGO.get()));
    
    public static final RegistryObject<SwordItem> SEIJUUKEN = ITEMS.register("starbeast_sword",
			() -> new BaseSwordItem(Tiers.DIAMOND, 4, 3.5f, new Item.Properties()).AddToTabList(ModClientEvents.FORM_WEAPON_ITEM).AddToTabList(RangerTabs.GINGAMAN).ChangeRepairItem(GINGAMAN_LOGO.get()));
    
    public static final RegistryObject<SwordItem> KIBA_CUTTER = ITEMS.register("kiba_cutter",
			() -> new BaseSwordItem(Tiers.DIAMOND, 4, 3.5f, new Item.Properties()).AddToTabList(RangerTabs.GINGAMAN).ChangeRepairItem(GINGAMAN_LOGO.get()));
    
    public static final RegistryObject<BaseBlasterItem> KIBA_SHOT = ITEMS.register("kiba_shot",
			() -> new BaseBlasterItem(Tiers.DIAMOND, 4, 3.5f, new Item.Properties()).AddToTabList(RangerTabs.GINGAMAN).ChangeRepairItem(GINGAMAN_LOGO.get()));
    ...
    public static final RegistryObject<BaseBlasterItem> JUUGEKIBOU_RED = ITEMS.register("beast_attack_rod_red",
			() -> new BaseBlasterItem(Tiers.DIAMOND, 4, 3.5f, new Item.Properties()).setProjectileLargeFireball(1).AddToTabList(ModClientEvents.FORM_WEAPON_ITEM).AddToTabList(ModClientEvents.FORM_WEAPON_ITEM).AddToTabList(RangerTabs.GINGAMAN).ChangeRepairItem(GINGAMAN_LOGO.get()));
	
    public static final RegistryObject<BaseBlasterItem> JUUGEKIBOU_GREEN = ITEMS.register("beast_attack_rod_green",
			() -> new BaseBlasterItem(Tiers.DIAMOND, 4, 3.5f, new Item.Properties()).setProjectileLargeFireball(1).AddToTabList(ModClientEvents.FORM_WEAPON_ITEM).AddToTabList(RangerTabs.GINGAMAN).ChangeRepairItem(GINGAMAN_LOGO.get()));
    ...
    public static final RegistryObject<BaseBlasterItem> BULL_RIOT = ITEMS.register("bull_riot",
			() -> new BaseBlasterItem(Tiers.DIAMOND, 4, 3.5f, new Item.Properties()).isChanger(BLACK_KNIGHT_BULL_RIOT.get()).AddToTabList(ModClientEvents.SWORD_GUN_ITEM).AddToTabList(RangerTabs.GINGAMAN).ChangeRepairItem(GINGAMAN_LOGO.get()));
