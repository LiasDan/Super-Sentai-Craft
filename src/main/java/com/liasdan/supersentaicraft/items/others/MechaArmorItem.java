...
public class MechaArmorItem extends ArmorItem implements GeoItem {
	...
	public MechaArmorItem(ArmorMaterial material, Type type, Properties properties) {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar controllerRegistrar) {
		controllerRegistrar.add(new AnimationController<MechaArmorItem>(this, "controller", 0, this::predicate));
	}
