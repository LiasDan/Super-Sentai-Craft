...
public class MechaGattaiItem extends MechaArmorItem{
	...
	public MechaGattaiItem (ArmorMaterial material, String rider,RegistryObject<Item> baseFormItem,RegistryObject<Item>torso,RegistryObject<Item> legs,RegistryObject<Item> boot, Properties properties)
	{
	...
	public void onArmorTick(ItemStack stack, Level level, Player player)
	{
		...
		if (player.getItemBySlot(EquipmentSlot.FEET).getItem() == BOOTS){
	...
	public MechaGattaiItem Add_Extra_Base_Form_Items(RegistryObject<Item> item) {
	...
	public MechaGattaiItem Add_Extra_Base_Form_Items(RegistryObject<Item> item,RegistryObject<Item> item2) {
		Extra_Base_Form_Item= Lists.newArrayList((RangerFormChangeItem)item.get(),(RangerFormChangeItem)item2.get());
		Num_Base_Form_Item=3;
		return this;
	}

	public MechaGattaiItem Add_Extra_Base_Form_Items(RegistryObject<Item> item,RegistryObject<Item> item2,RegistryObject<Item> item3) {
	...
	public static void set_Form_Item(ItemStack itemstack, Item ITEM,int SLOT)
	{
		...
		if (itemstack.getItem() instanceof MechaGattaiItem) {
			((MechaGattaiItem)itemstack.getItem()).Extra_set_Form_Item(itemstack, ITEM, SLOT);
