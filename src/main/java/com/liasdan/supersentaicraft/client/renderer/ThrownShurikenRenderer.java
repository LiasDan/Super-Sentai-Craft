...
public class ThrownShurikenRenderer<T extends Entity & ItemSupplier> extends EntityRenderer<T> {
	   ...
	   public ThrownShurikenRenderer(EntityRendererProvider.Context p_174416_, float p_174417_, boolean p_174418_) {
	      super(p_174416_);
	   ...
	   public ThrownShurikenRenderer(EntityRendererProvider.Context p_174414_) {
