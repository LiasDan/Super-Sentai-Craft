package com.liasdan.supersentaicraft.effect.Effect_Handlers;
...
public class FlyingHandler {
	...
	private static void execute(Entity entity) {
		...
		if (entity instanceof LivingEntity _livEnt ? _livEnt.hasEffect(EffectCore.FLYING.get()) : false) {
			if (entity instanceof Player _player) {
				_player.getAbilities().mayfly = (true);
				_player.onUpdateAbilities();
			}
		}	
		else if (!(entity instanceof LivingEntity _livEnt ? _livEnt.hasEffect(EffectCore.FLYING.get()) : false)) {
			if (entity instanceof Player _player) {
